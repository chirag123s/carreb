            ...
            <div className="container px-4 md:px-6 py-8 md:py-12">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2">
                    <li><Link href="" className="text-sm text-white">Car Guides</Link></li>
                    <li><Link href="" className="text-sm text-white">Comparison Tool</Link></li>
                    <li><Link href="" className="text-sm text-white">Green Cars</Link></li>
                    <li><Link href="" className="text-sm text-white">Best New Cars</Link></li>
                    <li><Link href="" className="text-sm text-white">Car News</Link></li>
                  </ul>*/}
                </div>
                
                <div className="space-y-3">
                  <h3 className="text-sm font-medium">Company</h3>
                  <ul className="space-y-2 p-revert">
                    <li><Link href="/about-us" className="text-sm text-white">About Us</Link></li>
                    <li><Link href="/privacy-policy" className="text-sm text-white">Privacy Policy</Link></li>
                    <li><Link href="/terms-of-use" className="text-sm text-white">Terms of Service</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t flex flex-col md:flex-row justify-between items-center">
                <p className="text-xs text-white">
                  &copy; {new Date().getFullYear()} Carreb, Inc. All rights reserved.
                </p>
                <div className="mt-4 md:mt-0 flex items-center space-x-4">
                  {/*
                  <Link href="" className="text-xs text-white">Privacy</Link>
                  <Link href="" className="text-xs text-white">Terms</Link>*/}
                </div>
              </div>
            </div>
          </footer>
