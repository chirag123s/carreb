            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2">
                  <li><Link href="" className="text-sm text-muted-foreground hover:text-foreground">Car Guides</Link></li>
                  <li><Link href="" className="text-sm text-muted-foreground hover:text-foreground">Comparison Tool</Link></li>
                  <li><Link href="" className="text-sm text-muted-foreground hover:text-foreground">Green Cars</Link></li>
                  <li><Link href="" className="text-sm text-muted-foreground hover:text-foreground">Best New Cars</Link></li>
                  <li><Link href="" className="text-sm text-muted-foreground hover:text-foreground">Car News</Link></li>
                </ul>
              </div>
